                                            ...
                                            <tr class="removable-item">
                                                ...
                                                <td>
                                                    <div class="action__buttons">
                                                        <a href="{{ route('category.edit', [$category->uuid]) }}" title="Edit"
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    if (response.success) {
                                        Swal.fire({
                                            title: 'Éxito',
                                            text: response.message || 'Categorías eliminadas correctamente.',
                                            icon: 'success'
                                        }).then(() => {
                                            location.reload();
                                        });
                                        ...
                                        Swal.fire({
                                            title: 'Error',
                                            text: response.message || 'No se pudieron eliminar las categorías.',
                                            icon: 'error'
                                        });
                                    }
                                },
                                error: function (xhr) {
                                    Swal.fire({
                                        title: 'Error',
                                        text: xhr.responseJSON?.message || 'Ocurrió un error al eliminar las categorías seleccionadas.',
                                        icon: 'error'
                                    });
                                }
                            });
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function (xhr) {
                                Swal.fire({
                                    title: 'Error',
                                    text: xhr.responseJSON?.message || 'No se pudo eliminar la categoría. Por favor, inténtelo de nuevo más tarde.',
                                    icon: 'error'
                                });
                            }
                        });
